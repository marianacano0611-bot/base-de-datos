...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2025 a las 01:05:40
...
(1, 'Comuna 1 - Popular', 'Granizal'),
(2, 'Comuna 1 - Popular', 'El Popular'),
(3, 'Comuna 1 - Popular', 'Santo Domingo Savio'),
(4, 'Comuna 2 - Santa Cruz', 'La Isla'),
(5, 'Comuna 2 - Santa Cruz', 'Villa del Socorro'),
(6, 'Comuna 2 - Santa Cruz', 'Pablo VI'),
(7, 'Comuna 3 - Manrique', 'Versalles'),
(8, 'Comuna 3 - Manrique', 'La Cruz'),
(9, 'Comuna 3 - Manrique', 'La Honda'),
(10, 'Comuna 4 - Aranjuez', 'Berlín'),
(11, 'Comuna 4 - Aranjuez', 'Aranjuez'),
(12, 'Comuna 4 - Aranjuez', 'Moravia'),
(13, 'Comuna 5 - Castilla', 'Boyacá'),
(14, 'Comuna 5 - Castilla', 'Castilla'),
(15, 'Comuna 5 - Castilla', 'Héctor Abad Gómez'),
(16, 'Comuna 6 - Doce de Octubre', 'San Martín de Porres'),
(17, 'Comuna 6 - Doce de Octubre', 'La Esperanza'),
(18, 'Comuna 6 - Doce de Octubre', 'Picacho'),
(19, 'Comuna 7 - Robledo', 'Palenque'),
(20, 'Comuna 7 - Robledo', 'El Diamante'),
(21, 'Comuna 1', 'Buenos Aires'),
(22, 'Comuna 1', 'La Milagrosa'),
(23, 'Comuna 2', 'Santa Cruz'),
(24, 'Comuna 2', 'La Isla'),
(25, 'Comuna 3', 'Manrique Central'),
(26, 'Comuna 3', 'La Salle'),
(27, 'Comuna 4', 'Aranjuez'),
(28, 'Comuna 4', 'Berlín'),
(29, 'Comuna 5', 'Castilla'),
(30, 'Comuna 5', 'Florencia'),
(31, 'Comuna 6', 'Doce de Octubre'),
(32, 'Comuna 6', 'La Esperanza'),
(33, 'Comuna 7', 'Robledo'),
(34, 'Comuna 7', 'Córdoba'),
(35, 'Comuna 8', 'Villa Hermosa'),
(36, 'Comuna 8', 'El Pinal'),
(37, 'Comuna 9', 'Buenos Aires'),
(38, 'Comuna 10', 'La Candelaria'),
(39, 'Comuna 11', 'Laureles'),
(40, 'Comuna 12', 'Los Colores');
...
(1, 'PlayStation 5', 'PS5-AX91K23', 12, '192.168.1.10', 'A4:B1:C2:D3:E4:10'),
(2, 'Xbox Series X', 'XSX-KS82M11', 8, '192.168.1.11', 'A4:B1:C2:D3:E4:11'),
(3, 'Nintendo Switch', 'NSW-LP33F88', 15, '192.168.1.12', 'A4:B1:C2:D3:E4:12'),
(4, 'PlayStation 4', 'PS4-ZM55Q91', 6, '192.168.1.13', 'A4:B1:C2:D3:E4:13'),
(5, 'Xbox One S', 'XOS-BT12H44', 10, '192.168.1.14', 'A4:B1:C2:D3:E4:14'),
(6, 'Nintendo Switch Lite', 'NSL-CC76T70', 9, '192.168.1.15', 'A4:B1:C2:D3:E4:15'),
(7, 'PlayStation 3', 'PS3-HF22M08', 4, '192.168.1.16', 'A4:B1:C2:D3:E4:16'),
(8, 'Xbox 360', 'X360-JU90S21', 5, '192.168.1.17', 'A4:B1:C2:D3:E4:17'),
(9, 'Steam Deck', 'STD-RS55V19', 7, '192.168.1.18', 'A4:B1:C2:D3:E4:18'),
(10, 'PlayStation Vita', 'PSV-PL88A56', 3, '192.168.1.19', 'A4:B1:C2:D3:E4:19'),
(11, 'Nintendo 3DS', 'N3D-KQ19T33', 5, '192.168.1.20', 'A4:B1:C2:D3:E4:20'),
(12, 'PlayStation 2', 'PS2-WE77D01', 2, '192.168.1.21', 'A4:B1:C2:D3:E4:21'),
(13, 'Xbox One X', 'XOZ-HD44M79', 6, '192.168.1.22', 'A4:B1:C2:D3:E4:22'),
(14, 'Nintendo Wii', 'WII-ZX11C57', 4, '192.168.1.23', 'A4:B1:C2:D3:E4:23'),
(15, 'PlayStation Portable', 'PSP-VB02N60', 3, '192.168.1.24', 'A4:B1:C2:D3:E4:24'),
(16, 'Atari Flashback', 'ATF-TU33P92', 8, '192.168.1.25', 'A4:B1:C2:D3:E4:25'),
(17, 'Sega Genesis Mini', 'SGM-MP44K81', 6, '192.168.1.26', 'A4:B1:C2:D3:E4:26'),
(18, 'PlayStation 5 Digital', 'PS5D-OK71S54', 9, '192.168.1.27', 'A4:B1:C2:D3:E4:27'),
(19, 'Xbox Series S', 'XSS-RL92B10', 11, '192.168.1.28', 'A4:B1:C2:D3:E4:28'),
(20, 'Nintendo Switch OLED', 'NSO-GG66J77', 10, '192.168.1.29', 'A4:B1:C2:D3:E4:29'),
(21, 'PlayStation 5', 'PS5-9348231', 12, '192.168.1.10', 'A4:B2:C3:D4:E5:01'),
(22, 'Xbox Series X', 'XSX-2239842', 8, '192.168.1.11', 'A4:B2:C3:D4:E5:02'),
(23, 'Nintendo Switch', 'NSW-5538271', 15, '192.168.1.12', 'A4:B2:C3:D4:E5:03'),
(24, 'PlayStation 4', 'PS4-7643920', 5, '192.168.1.13', 'A4:B2:C3:D4:E5:04'),
(25, 'Xbox One S', 'XOS-2348894', 7, '192.168.1.14', 'A4:B2:C3:D4:E5:05'),
(26, 'Steam Deck', 'STD-9983241', 4, '192.168.1.15', 'A4:B2:C3:D4:E5:06'),
(27, 'PlayStation 3', 'PS3-8834921', 3, '192.168.1.16', 'A4:B2:C3:D4:E5:07'),
(28, 'Xbox 360', 'X360-1293847', 6, '192.168.1.17', 'A4:B2:C3:D4:E5:08'),
(29, 'Nintendo Wii', 'WII-8392011', 2, '192.168.1.18', 'A4:B2:C3:D4:E5:09'),
(30, 'Nintendo Wii U', 'WUU-7483921', 3, '192.168.1.19', 'A4:B2:C3:D4:E5:0A'),
(31, 'PlayStation Vita', 'PSV-9348831', 9, '192.168.1.20', 'A4:B2:C3:D4:E5:0B'),
(32, 'Nintendo 3DS', '3DS-2347789', 11, '192.168.1.21', 'A4:B2:C3:D4:E5:0C'),
(33, 'PlayStation 2', 'PS2-0093847', 5, '192.168.1.22', 'A4:B2:C3:D4:E5:0D'),
(34, 'Xbox Classic', 'XBX-8374621', 2, '192.168.1.23', 'A4:B2:C3:D4:E5:0E'),
(35, 'GameCube', 'GMC-9982341', 3, '192.168.1.24', 'A4:B2:C3:D4:E5:0F'),
(36, 'Sega Dreamcast', 'DCT-2239847', 1, '192.168.1.25', 'A4:B2:C3:D4:E5:10'),
(37, 'PlayStation Portable', 'PSP-3348921', 6, '192.168.1.26', 'A4:B2:C3:D4:E5:11'),
(38, 'Atari Flashback', 'ATF-0293847', 4, '192.168.1.27', 'A4:B2:C3:D4:E5:12'),
(39, 'Retro Mini NES', 'RMS-8834921', 10, '192.168.1.28', 'A4:B2:C3:D4:E5:13'),
(40, 'Retro Mini SNES', 'RMS-5530021', 8, '192.168.1.29', 'A4:B2:C3:D4:E5:14');
...
--
ALTER TABLE `comuna_barrio`
  MODIFY `id_comuna` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT de la tabla `consola`
--
ALTER TABLE `consola`
  MODIFY `id_consola` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
